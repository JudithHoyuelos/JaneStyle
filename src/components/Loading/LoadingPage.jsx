...
const LoadingPage = () => {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.logoContainer}>
        <Image asset={"img/logos/Property 1=logo purple.svg"} alt="Logo" width={200} height={200} className={styles.logoWhite} />
        <Image asset={"img/logos/Property 1=Variant2.svg"} alt="Logo" width={200} height={200} className={styles.logoColor} />
